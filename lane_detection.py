...
class Lane_Detection:
    ...
    def warp_image(self):
        ...
        img_size = (self.combined_binary.shape[1], self.combined_binary.shape[0])
        ...
        self.binary_warped = cv2.warpPerspective(self.combined_binary, M, img_size, flags=cv2.INTER_LINEAR)
